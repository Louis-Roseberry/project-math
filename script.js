...
addQuestion("trouve l'air de ce polygone régulier.", "74.175dm^2", "images/polygone regulier2.png");
addQuestion("trouve l'air de Parallélogramme.", "182dam^2", "images/paralleogramme.png");
